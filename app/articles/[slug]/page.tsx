    ...
    <article className="min-h-screen py-20 mt-5">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <header className="mb-12 text-center">
          <h1 className="text-3xl lg:text-5xl font-light text-gray-100 mb-6 leading-tight">
            {post.title}
          </h1>

          <div className="flex items-center justify-center gap-6 text-sm text-gray-400 mb-8">
            <div className="flex items-center gap-2">
              <HiUser size={16} /> {post.author || "Unknown Author"}
            </div>
            <div className="flex items-center gap-2">
              <HiCalendar size={16} /> {new Date(post.date).toLocaleDateString()}
            </div>
            <div className="flex items-center gap-2">
              <HiClock size={16} /> {readingTime}
            </div>
          </div>
